...
Tables.prototype.parse = function() {
  ...
  if (!this.options.stdin) {
    ...
    if (!this.options.restart && info && info.current && info.current < info.total && this.options.inputType === "csv") {
...
Tables.prototype.guessModel = function() {
  ...
  function streamDone() {
    ...
    thisTables.options.models[tableName] = columnsToModel(columns, thisTables.options.key, tableName);
