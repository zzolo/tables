...
StreamSQL.prototype.parse = function() {
  ...
  s.pipe(this.inputParser())
    .on("data", function(data) {
      ...
      thisStreamSQL.insertBatch(parsed, s, this, false);
    })
    .on("end", function() {
      thisStreamSQL.talk("Parsing done");
      thisStreamSQL.insertBatch(null, s, this, true);
    });
};

// Handle batch.  Split up batches into models
StreamSQL.prototype.insertBatch = function(data, streamProcess, parseProcess, force, done) {
  var q;
  var split = {};
